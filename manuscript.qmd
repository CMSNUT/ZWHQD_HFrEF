...
tbl_1 <- read.xlsx("tables/Table1.xlsx", sep.names = " ")  %>%
  mutate(Herb = Herb.Name.Pinyin,
         Ingredient = Compound.Name,
         PubChem_CID = CID
         ) %>%
  dplyr::select(Herb,Ingredient,PubChem_CID,SMILES)
...
Herbs of Zhenwu Huangqi Decoction (ZWHQD).
:::
