...
ggsave("../figures/supplementary/nFigure_S1A.pdf",p, width = 14,height = 8,units = "cm", dpi = 300)
...
# Check normalization
pdf("../figures/supplementary/nFigure_S1B.pdf", width = 14, height = 8)
boxplot(expr_filt, 
        las = 2,  
...
p <- ggplot(pca_df, aes(PC1, PC2, color = Group)) + 
  ...
  stat_ellipse() + 
  theme_minimal()
ggsave("../figures/supplementary/nFigure_S1C.pdf",p, width = 7,height = 5,units = "cm", dpi = 300)
...
ggsave("../figures/main/nFigure_2A.pdf",p_volcano, width = 7,height = 5,dpi = 300)
```
...
pdf("../figures/main/nFigure_2B.pdf", width = 7, height = 5)
print(p_heat)
dev.off()
```
