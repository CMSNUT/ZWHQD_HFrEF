...
herbs <- read.xlsx("results/tables/supplementary/Table_S1_Herbs_and_Compounds_of_Zhenwu_Huangqi_Decoction.xlsx", sheet = "Final_Active_Compounds", sep.names = " ") 
...
```{r}
#| label: supptbl-2
#| tbl-cap: "Herbs, ingredients and corresponding targets in Zhenwu Huangqi Decoction (ZWHQD)."
#| echo: false
#| eval: true
#| width: 100%
