...
CHF, chronic heart failure; HFrEF, Heart Failure with Reduced Ejection Fraction; TCM, traditional Chinese medicine; ZWHQD, Zhenwu-Huangqi decoction; MR, Mendelian randomization; GSEA, gene set enrichment analysis; GEO, Gene Expression Omnibus; RNA-seq, RNA sequencing; scRNA-seq, single-cell RNA sequencing; HC, healthy control; FC, fold change; DEGs, differentially expressed genes; WGCNA, weighted gene co-expression network analysis; GS, gene significance; MM, module membership; DCABM-TCM, Database of Constituents Absorbed into the Blood and Metabolites of Traditional Chinese Medicine, BATMAN-TCM, Bioinformatics Analysis Tool for Molecular mechANism of Traditional Chinese Medicine; MCODE, Molecular Complex Detection; GO, gene ontology; KEGG, Kyoto encyclopedia of genes and genomes; CC, cell component; BP, biological process; MF, molecular function; PCA, principal component analysis; UMAP, Uniform Manifold Approximation and Projection; t-SNE, t-distributed Stochastic Neighbor Embedding; eQTL, expression quantitative trait loci; SNP, single nucleotide polymorphisms; IV, instrumental variable; GWAS, genome-wide association study; PVE, proportion of variance explained; IVW, inverse variance weighted; OR, Odds Ratio; MR-PERSSO, MR pleiotropy residual sum and outlier; PP. H, posterior probability of hypothesis; ROC, receiver operating characteristic; DCA, decision curve analysis; PI3K, phosphoinositide 3 kinase; AKT, serine/threonine kinase; MAPK, mitogen-activated protein kinase; TNF, tumor necrosis factor; IL, interleukin; CD, cluster of differentiation; NK, natural killer; HLA, human leukocyte antigen; PIP2, phosphatidylinositol-4,5-bisphosphate; PIP3, phosphatidylinositol-3, 4, 5-bisphosphate; PTEN, phosphatase and tensin homolog; PDK1, phosphatidylinositol 3-phosphate-dependent protein kinase-1; FLS, fibroblast-like synoviocytes; OC, osteoclast; RANKL, receptor activator for nuclear factor-κB ligand.
...
```{r}
#| label: tbl-1
#| tbl-cap: "Herbs of Zhenwu Huangqi Decoction (ZWHQD)."
#| echo: false
#| eval: true
#| width: 100%
#| results: asis
...
herbs <- read.xlsx("results/tables/main/Table1_Herbs_of_Zhenwu_Huangqi_Decoction.xlsx", sep.names = " ") %>%
  mutate(`Latin Name` = text_spec(`Latin Name`, italic = TRUE))
...
herbs %>%
  ...
  row_spec(nrow(herbs), extra_css = "border-bottom: 1px solid #000 !important;") 
```
