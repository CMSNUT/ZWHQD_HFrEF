...
if (!require("WGCNA")) BiocManager::install("WGCNA", dependencies = TRUE)
if (!require("flashClust")) install.packages("flashClust", dependencies = TRUE)
if (!require("robustbase")) install.packages("robustbase", dependencies = TRUE)
if (!require("dynamicTreeCut")) install.packages("dynamicTreeCut", dependencies = TRUE)


if (!require("cowplot")) install.packages("cowplot", dependencies = TRUE)
if (!require("ggvenn")) install.packages("ggvenn", dependencies = TRUE)
...
## Figure S2A
```{r}
pdf("../figures/supplementary/Figure_S2A.pdf", width=10, height=5)
...
## Figure S2B
```{r}
pdf("../figures/supplementary/Figure_S2B.pdf", width=14, height=5)
par(mfrow = c(1,2))
...
## Figure 2D
```{r}
pdf("../figures/main/Figure_2D.pdf", width = 7, height = 10)
...
## Figure 2E
```{r}
pdf("../figures/main/Figure_2E.pdf", width=7, height=5)
...
pdf("../figures/main/Figure_2F.pdf", width=7, height=5)
...
# save
ggsave("../figures/main/Figure_2G.pdf", p, width=6, height=6, dpi=300)
```
