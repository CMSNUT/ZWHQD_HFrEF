...
## Step 5: Significant difference genes
```{r}
# lfc <- log2(1.5)
lfc <- 0.585
...
ggsave("../figures/main/nFigure_2A.png", p_volcano, width = 7, height = 5, dpi = 300)
```
...
png("../figures/main/nFigure_2B.png", width = 7, height = 5, res = 300, units = "in")
print(p_heat)
dev.off()
```
